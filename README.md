...
[![Stars](https://img.shields.io/github/stars/Nezur-Execute-Update-v2.4?style=flat-square)](https://github.com)
...
git clone https://github.com/Nezur-Execute-Update-v2.4.git
cd Nezur-Execute-Update-v2.4
